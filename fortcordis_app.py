...
def _db_init():
    # Usar conexão própria para DDL (evita ProgrammingError quando a conexão em cache
    # está fechada, ex.: após importação ou ao carregar JSON para edição no Streamlit Cloud)
